...
public class Drive extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            double y = -gamepad1.left_stick_y * speedScale; // Remember, Y stick value is reversed
            double x = gamepad1.left_stick_x * speedScale;
            double rx = -gamepad1.right_stick_x * speedScale;
