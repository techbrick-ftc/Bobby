...
public class subHang {
    ...
    int[] init = {2100, 1850, 5700};
    int[] lowHang1 = {2260, 2850, 2800};
    int[] lowHang2 = {2580, 2850, 2800};
    int[] hookSlides = {2500, 2450, 2800};
    int[] pullUp = {2190, 1100, 1450};
    int[] rotate = {1940, 1100, 1450};
    int[] pullHigher = {1400, 290, 720};
    int[] finalize = {1030, 70, 30};
