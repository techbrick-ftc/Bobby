...
public class subNewArm {

    public subShoulder should;
    public subNewGrab grab;
    ...
    double groundHoverAngle = 0;
    double groundIntakeAngle = 0;
    double binDepositAngle = 0;
    double clawWallAngle = 0;
    double clawDepositAngle = 0;
    ...
    public subNewArm(HardwareMap hardwareMap) {
        should = new subShoulder(hardwareMap);
        grab = new subNewGrab(hardwareMap);
    }
